...
export default function App() {
  ...
  return <main className="public-list">
    ...
    <section id="lists" className="content">
      ...
      <div className="legend"><span className="dot green" />В пределах бюджетных мест <span className="dot purple" />Рекомендованы к зачислению на платной основе <span className="dot blue" />Оригинал документа <span className="dot amber" />Льгота</div>
